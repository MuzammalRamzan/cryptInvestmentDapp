...
interface ModalTokenAllocationInfoProps {
  isOpen: boolean;
  onClose: () => void;
}

const ModalTokenAllocationInfo: React.FC<ModalTokenAllocationInfoProps> = ({
  isOpen,
  onClose,
}) => {
...
export default ModalTokenAllocationInfo;
