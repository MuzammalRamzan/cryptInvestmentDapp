    ...
    <>
      {items.map((item, i) => (
        <div
          ...
          key={i}
        >
          <span className="relative w-full px-5 bg-[#0f131e] py-2.5 transition-all ease-in duration-75 rounded-xl text-white ">
            <div className="flex w-full items-center gap-2">
              ...
              <div className="flex flex-col space-y-1">
                ...
                <p className="text-xs font-light">{t(item.subTitle)}</p>
              </div>
            </div>
          </span>
        </div>
